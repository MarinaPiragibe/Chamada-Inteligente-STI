...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference("Turma.count") do
      post turmas_url, params: { turma: { cod_turma: @turma.cod_turma, hora_fim: @turma.hora_fim, hora_inicio: @turma.hora_inicio } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { cod_turma: @turma.cod_turma, hora_fim: @turma.hora_fim, hora_inicio: @turma.hora_inicio } }
