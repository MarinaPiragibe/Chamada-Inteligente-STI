class Turmasgenerator < ActiveRecord::Migration[7.0]
  def change
    Turma.create(id:1, cod_turma: "A1", hora_inicio:20,hora_fim:24,professors_id:1,disciplinas_id:1,dias:["segunda","quarta","terça","quinta","sexta"],aulas_semestre: 20, aulas_com_chamada: 0, chamada_ativa:1)
